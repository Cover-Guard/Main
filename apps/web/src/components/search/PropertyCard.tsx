        ...
        <div className="card overflow-hidden transition-all hover:shadow-md hover:border-gray-300">
              <Link href={`/properties/${property.id}`} className="block p-5">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div>
                                        <div className="text-[10px] text-gray-400 uppercase tracking-wide">Est. value</div>div>
                                        <div className="text-lg font-bold text-gray-900">{formatCurrency(property.estimatedValue)}</div>div>
                        </div>div>
                                            )}
                                  {property.lastSalePrice && (
                        <div className="mt-1">
                                        <div className="text-[10px] text-gray-400 uppercase tracking-wide">Last sale</div>div>
          ...
          {/* Compare toggle when no onViewReport */}
          {!onViewReport && (
