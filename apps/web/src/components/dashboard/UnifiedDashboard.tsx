          ...
          {(['ALL', 'PENDING', 'SENT', 'RESPONDED', 'BOUND', 'DECLINED'] as const).map((s) => (
            ...
            <button
              ...
              className={cn(
                ...
                statusFilter === s ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'  <button className="text-[11px] font-semibold text-teal-600 hover:text-teal-700">
...
function RolePanel({ role, agentFlavor }: { role: Role; agentFlavor: AgentFlavor }) {
  ...
  if (role ===          q.status === 'PENDING' && 'bg-gray-100 text-gray-600',
...
function RolePanel({ role, agentFlavor }: { role: Role; agentFlavor: AgentFlavor }) {
  ...
  if (role === 'INSURANCE') {
    ...
    0               i.priority === 'LOW' && 'bg-gray-100 text-gray-600',
