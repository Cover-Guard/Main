/**
 * Single source of truth for the NDA legal text.
 * Used by NDAReadRequirement (inline scroll viewer), the /nda page, and onboarding.
 */
export default function NDAContent({ className }: { className?: string }) {
  return (
