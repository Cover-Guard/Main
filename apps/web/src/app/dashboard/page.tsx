...
import { LenderPortfolioDashboard } from '@/components/dashboard/LenderPortfolioDashboard'
...
export default async function DashboardPage() {
  ...
  return (
    <SidebarLayout>
      <DashboardWithTabs>
        {isLender ? <LenderPortfolioDashboard /> : isAgent ? <AgentDashboard /> : <ConsumerDashboard />}
      </DashboardWithTabs>
    </SidebarLayout>
  )
}
