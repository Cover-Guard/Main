  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="border-t border-gray-200 bg-gray-50">
        <div className="mx-auto max-w-5xl px-4 py-8 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-gray-500">
            <Shield className="h-5 w-5" />
            <span className="text-sm font-medium">CoverGuard, Inc.</span>
          </div>
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/login" className="text-sm text-gray-500 hover:underline">&larr; Back to Sign In</Link>
          </div>
        </div>
      </div>
    </div>
