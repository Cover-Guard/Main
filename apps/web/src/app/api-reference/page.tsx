      ...
      <main className="min-h-screen bg-white">
        <section className="bg-gradient-to-b from-brand-50/50 via-white to-white pt-32 pb-16 sm:pt-40 sm:pb-20">
          <div className="mx-auto max-w-5xl px-4 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">Build on top of CoverGuard. Access property risk data, carrier availability, and quote workflows programmatically.</p>
          </div>
        </section>
