    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="hidden w-5/12 flex-col justify-between bg-brand-900 p-12 lg:flex">
        ...
        <div>
          ...
          <h2 className="text-3xl font-bold text-white">Know your property&apos;s risk before you buy</h2>
          <p className="mt-3 text-brand-300">Create a free account to search properties, compare risks, and request insurance quotes.</p>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Are you an agent?{' '}
              <Link href="/agents/register" className="text-brand-600 hover:underline">Agent sign-up &rarr;</Link>
            </p>
          </div>
