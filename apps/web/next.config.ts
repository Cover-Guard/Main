        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: *.supabase.co maps.googleapis.com maps.gstatic.com *.google.com *.ggpht.com *.googleusercontent.com coverguard.io www.coverguard.io hazards.fema.gov apps.fs.usda.gov coast.noaa.gov *.arcgis.com earthquake.usgs.gov avatars.githubusercontent.com",
              "font-src 'self' fonts.gstatic.com",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.github.com https://maps.googleapis.com https://*.googleapis.com https://*.gstatic.com https://*.googleusercontent.com https://hazards.fema.gov https://apps.fs.usda.gov https://coast.noaa.gov https://*.arcgis.com https://earthquake.usgs.gov",
