        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: *.supabase.co maps.googleapis.com maps.gstatic.com *.google.com *.ggpht.com lh3.googleusercontent.com coverguard.io www.coverguard.io hazards.fema.gov apps.fs.usda.gov coast.noaa.gov",
              "font-src 'self' fonts.gstatic.com",
              "connect-src 'self' *.supabase.co maps.googleapis.com *.googleapis.com *.gstatic.com hazards.fema.gov apps.fs.usda.gov coast.noaa.gov",
